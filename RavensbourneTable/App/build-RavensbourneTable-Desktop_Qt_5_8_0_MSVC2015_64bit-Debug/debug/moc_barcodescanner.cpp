...
#include "../../RavensbourneTable/barcodescanner.h"
...
QT_MOC_LITERAL(1, 15, 7), // "newCode"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "portname"
QT_MOC_LITERAL(4, 33, 7), // "barcode"
QT_MOC_LITERAL(5, 41, 5) // "count"

    },
    "BarcodeScanner\0newCode\0\0portname\0"
    "barcode\0count"
};
...
void BarcodeScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BarcodeScanner *_t = static_cast<BarcodeScanner *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newCode((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: { quint32 _r = _t->count();
        ...
        {
            typedef void (BarcodeScanner::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BarcodeScanner::newCode)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BarcodeScanner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BarcodeScanner.data,
      qt_meta_data_BarcodeScanner,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BarcodeScanner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BarcodeScanner.stringdata0))
        return static_cast<void*>(const_cast< BarcodeScanner*>(this));
...
// SIGNAL 0
void BarcodeScanner::newCode(QString _t1, QString _t2)
{
