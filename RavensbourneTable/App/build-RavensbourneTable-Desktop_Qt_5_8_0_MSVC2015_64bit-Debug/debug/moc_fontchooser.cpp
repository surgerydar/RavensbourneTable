...
#include "../../RavensbourneTable/fontchooser.h"
...
QT_MOC_LITERAL(1, 12, 11), // "fontChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "font"
QT_MOC_LITERAL(4, 30, 6), // "colour"
QT_MOC_LITERAL(5, 37, 7) // "getFont"

    },
    "FontChooser\0fontChanged\0\0font\0colour\0"
    "getFont"
};
...
static const uint qt_meta_data_FontChooser[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QFont, QMetaType::QColor,    3,    4,
...
void FontChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fontChanged((*reinterpret_cast< QFont(*)>(_a[1])),(*reinterpret_cast< QColor(*)>(_a[2]))); break;
        case 1: { QFont _r = _t->getFont();
        ...
        {
            typedef void (FontChooser::*_t)(QFont , QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FontChooser::fontChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FontChooser::staticMetaObject = {
    { &CircularMenu::staticMetaObject, qt_meta_stringdata_FontChooser.data,
...
// SIGNAL 0
void FontChooser::fontChanged(QFont _t1, QColor _t2)
{
